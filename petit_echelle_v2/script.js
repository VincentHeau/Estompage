    ...
    layers: [
      new ol.layer.Tile({
        source: new ol.source.XYZ({
          url: 'https://raw.githubusercontent.com/VincentHeau/server-carto-lidarHD/refs/heads/main/tuiles_PE_ME/{z}/{x}/{y}.png', 
        }),
      }),
    ],
    view: new ol.View({
      center: ol.proj.fromLonLat([1,46]), // Centre de la carte
      zoom: 3, // Zoom initial
      minZoom: 1,
      maxZoom: 18,
    }),
...
function getLayerDetails(selectedValue) {
  switch (selectedValue) {
    ...
    case 'PE':
      return {
        url: 'https://cdn.jsdelivr.net/gh/VincentHeau/server-carto-lidarHD@main/tuiles_PE_ME/{z}/{x}/{y}.png',
        isVector: false,
        layerType: 'XYZ',
      };
    default:
